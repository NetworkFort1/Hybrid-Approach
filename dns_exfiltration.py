...
try:
    ...
    if path:
        ...
        # Rule-based labeling
        # If w_count > 5, label as “attack.”
        # If entropy < 1.0, label as “normal.”
        # If size_avg > 10, label as “attack.”
        dns_log['attack'] = np.where((dns_log['w_count'] > 5) |
                                      (dns_log['entropy'] < 1.0) |
                                      (dns_log['size_avg'] > 10), 'attack', 'normal')
